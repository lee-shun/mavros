...
int main(int argc, char **argv)
{
    ...
    */
    ...
    // 订阅 系统当前状态
    /*subscribe<sensor_msgs::NavSatFix>中的<>中的内容填写的是的类型，
    ...
    */
    ...
    outfile.open("/home/sss/GPS_sim_data.txt");
    ...
    {/*
        ...
        */
        ...
        cout <<fixed<< setprecision(10)<< current_state.latitude   << endl;
        cout <<fixed<< setprecision(10)<< current_state.longitude  << endl;
        cout <<fixed<< setprecision(10)<< current_state.altitude   << endl;
        cout << endl;

        outfile.setf(ios::fixed);
        outfile << i <<",";
        outfile <<fixed<< setprecision(10)<< current_state.latitude   <<",";
        outfile <<fixed<< setprecision(10)<< current_state.longitude  <<",";
        outfile <<fixed<< setprecision(10)<< current_state.altitude   << endl;
