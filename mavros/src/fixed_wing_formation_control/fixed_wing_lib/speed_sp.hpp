...
public:
    ...
    void update_airspeed_pos_p(_s_error error, _s_status follower_status, _s_status leader_status);
    
    //控制方案：相对位置误差,相对速度误差作为总控制误差，将这个error pid之后产生期望速度
    void update_airspeed_mix_vp(_s_error error, _s_status follower_status, _s_status leader_status);
private:
...
void SPEED_SP::update_airspeed_pos_p(_s_error error, _s_status follower_status, _s_status leader_status)
{
...
void SPEED_SP::update_airspeed_mix_vp(_s_error error, _s_status follower_status, _s_status leader_status)
{
